...
<head>
    ...
    <script type="text/javascript" src="http://www.chuangyehongniang.cn/static/js/scripts/city.js"></script>
    <link rel="stylesheet" type="text/css" href="http://www.chuangyehongniang.cn/static/css/index.css">
</head>

<body>
    <div class="container">
        <form method="post" action="http://www.chuangyehongniang.cn/users" name="form1">
    <div id="basicInfo">
        <div class="title">
            <p>一、个人信息</p>
        </div>
    ...
    <div id="proProfile">
        ...
        <section>
            ...
            <div class="proDevelop">
                ...
                <div class="prodev"><input type="radio" value="1" name="projectIfCost"><span>是</span></div>
                <div class="prodev"><input type="radio" value="0" name="projectIfCost"><span>否</span></div>
