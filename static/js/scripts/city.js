...
function first(preP, preC, VeryHuo, selectP, selectC) {
    ...
    } else { tempoption = new Option('北京', '北京'); }
    ...
    } else { tempoption = new Option('深圳', '深圳'); }
    ...
    } else { tempoption = new Option('上海', '上海'); }
    ...
    } else { tempoption = new Option('重庆', '重庆'); }
    ...
    } else { tempoption = new Option('天津', '天津'); }
    ...
    } else { tempoption = new Option('广东', '广东'); }
    ...
    } else { tempoption = new Option('河北', '河北'); }
    ...
    } else { tempoption = new Option('山西', '山西'); }
    ...
    } else { tempoption = new Option('内蒙古', '内蒙古'); }
    ...
    } else { tempoption = new Option('辽宁', '辽宁'); }
    ...
    } else { tempoption = new Option('吉林', '吉林'); }
    ...
    } else { tempoption = new Option('黑龙江', '黑龙江'); }
    ...
    } else { tempoption = new Option('江苏', '江苏'); }
    ...
    } else { tempoption = new Option('浙江', '浙江'); }
    ...
    } else { tempoption = new Option('安徽', '安徽'); }
    ...
    } else { tempoption = new Option('福建', '福建'); }
    ...
    } else { tempoption = new Option('江西', '江西'); }
    ...
    } else { tempoption = new Option('山东', '山东'); }
    ...
    } else { tempoption = new Option('河南', '河南'); }
    ...
    } else { tempoption = new Option('湖北', '湖北'); }
    ...
    } else { tempoption = new Option('湖南', '湖南'); }
    ...
    } else { tempoption = new Option('广西', '广西'); }
    ...
    } else { tempoption = new Option('海南', '海南'); }
    ...
    } else { tempoption = new Option('四川', '四川'); }
    ...
    } else { tempoption = new Option('贵州', '贵州'); }
    ...
    } else { tempoption = new Option('云南', '云南'); }
    ...
    } else { tempoption = new Option('西藏', '西藏'); }
    ...
    } else { tempoption = new Option('陕西', '陕西'); }
    ...
    } else { tempoption = new Option('甘肃', '甘肃'); }
    ...
    } else { tempoption = new Option('青海', '青海'); }
    ...
    } else { tempoption = new Option('宁夏', '宁夏'); }
    ...
    } else { tempoption = new Option('新疆', '新疆'); }
    ...
    } else { tempoption = new Option('香港', '香港'); }
    ...
    } else { tempoption = new Option('澳门', '澳门'); }
    ...
    } else { tempoption = new Option('台湾', '台湾'); }
